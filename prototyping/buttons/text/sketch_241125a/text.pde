...
color ink, teal=#36FFE2, red=#FFC1C1, black=#000000, white=#FFFFFF, resetDefaultInk=white; //Not Night Mode Friendly
int size;
...
void draw() {
  ...
  textAlign(LEFT, RIGHT); //Align X&Y, see Processing.org / Reference
  ...
  ink = (randomColor == true) ? color(random(0, 256), random(256), random(256)) : teal;
  fill(ink);
